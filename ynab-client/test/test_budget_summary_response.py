...
from openapi_client.models.budget_summary_response import BudgetSummaryResponse  # noqa: E501
...
class TestBudgetSummaryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.budget_summary_response.BudgetSummaryResponse()  # noqa: E501
        if include_optional :
            return BudgetSummaryResponse(
                data = openapi_client.models.budget_summary_response_data.BudgetSummaryResponse_data(
                    budgets = [
                    ...
                    default_budget = openapi_client.models.budget_summary.BudgetSummary(
                        id = '0', 
                        name = '0', 
                        last_modified_on = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        first_month = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
